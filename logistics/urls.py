...
urlpatterns = [
    ...
    path('warehouses/<int:warehouse_id>/receive-items/', views.receive_items_at_warehouse, name='receive_items_at_warehouse'),
    
    # Pickup point views
    path('pickup/', views.pickup_dashboard, name='pickup_dashboard'),
    path('pickup/<int:pickup_id>/', views.pickup_detail, name='pickup_detail'),
    path('items/<int:item_id>/deliver-to-customer/', views.deliver_item_to_customer, name='deliver_item_to_customer'),
    ...
    path('items/<int:item_id>/update-status/<str:new_status>/', views.update_item_status, name='update_item_status'),
    ...
    path('shipments/<int:shipment_id>/start-transit/', views.shipment_start_transit, name='shipment_start_transit'),
    path('shipments/<int:shipment_id>/mark-arrived/', views.shipment_mark_arrived, name='shipment_mark_arrived'),
    path('shipments/<int:shipment_id>/unload/', views.shipment_unload, name='shipment_unload'),
    path('shipments/<int:shipment_id>/complete/', views.shipment_complete, name='shipment_complete'),
    path('shipments/<int:shipment_id>/cancel/', views.shipment_cancel, name='shipment_cancel'),
